...
def get_days_from_today(date):
    ...
    try:
        ...
        # Обробка винятку, якщо вхідні дані мають неправильний формат
        print("Неправильний формат вхідної дати. Введіть дату у форматі 'РРРР-ММ-ДД'.")
        return f'Зробіть заміну дати {date} на формат <<РРРР-ММ-ДД>>'  # Або відповідно до вашого випадку, можна повертати False або якийсь інший прапорець, що позначатиме помилку
